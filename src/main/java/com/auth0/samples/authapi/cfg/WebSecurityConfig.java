...
import com.auth0.samples.authapi.security.JWTAuthenticationFilter;
import com.auth0.samples.authapi.security.JWTAuthorizationFilter;


@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.auth0.samples.authapi")
@EnableWebSecurity
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  /*
   * public WebSecurity(UserDetailsService userDetailsService, BCryptPasswordEncoder
